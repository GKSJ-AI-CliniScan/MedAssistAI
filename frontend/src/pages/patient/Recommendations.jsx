...
export default function Recommendations() {
  ...
  const generateRecommendations = async () => {
    ...
    // Generate mock recommendations based on health data
    const mockRecommendations = {
      bmi: bmi,
      bmiCategory: bmi < 18.5 ? "Underweight" : bmi < 25 ? "Normal" : bmi < 30 ? "Overweight" : "Obese",
      dietPlan: {
        calories: Math.round(2000 + (healthData.weight * 10)),
        meals: [
          { time: "Breakfast (7-8 AM)", foods: ["Oatmeal with fruits", "Greek yogurt", "Green tea", "Almonds (5-6)"] },
          { time: "Mid-Morning Snack (10 AM)", foods: ["Fresh fruit", "Nuts", "Herbal tea"] },
          { time: "Lunch (12-1 PM)", foods: ["Grilled chicken/fish", "Brown rice", "Steamed vegetables", "Salad"] },
          { time: "Evening Snack (4 PM)", foods: ["Protein shake", "Fruit", "Dark chocolate (small piece)"] },
          { time: "Dinner (7-8 PM)", foods: ["Lean protein", "Quinoa", "Roasted vegetables", "Soup"] }
        ],
        foodsToInclude: ["Leafy greens", "Lean proteins", "Whole grains", "Fruits", "Vegetables", "Healthy fats"],
        foodsToAvoid: ["Processed foods", "Excess sugar", "Fried foods", "High sodium foods"]
      },
      exercisePlan: {
        weeklySchedule: [
        ...
        dailySteps: 10000,
        workoutTips: ["Start slow and gradually increase intensity", "Stay hydrated during workouts", "Include warm-up and cool-down", "Listen to your body"]
      },
      lifestyle: {
        waterIntake: `${Math.round(healthData.weight * 0.033)} liters daily`,
        sleep: "7-9 hours per night",
        stressManagement: ["Practice meditation", "Deep breathing exercises", "Regular physical activity", "Social connections"],
        habits: ["Regular meal timing", "Limit screen time before bed", "Take breaks from sitting", "Practice good posture"]
      },
      followUpReminder: {
        nextCheckup: "3 months",
        recommendedTests: ["Complete blood count", "Lipid profile", "Blood sugar test", "Blood pressure check"],
        monitoring: ["Weight weekly", "Blood pressure monthly", "Energy levels daily", "Sleep quality"]
      }
    };
