...
export default function LoginPage() {
  ...
  const handleProviderLogin = async (providerName: "google") => {
    ...
    try {
      ...
      // User closed the popup or it was blocked — not an error, just silently reset
      if (
          ...
          <div className="hidden md:flex md:w-5/12 bg-primary/5 p-12 flex-col justify-between relative overflow-hidden border-l border-border/50">
            ...
            <div className="relative z-10">
              ...
              <p className="text-muted-foreground">
                Sign in to your account to securely access your health data, continue your AI consultations, and track your wellness.
              </p>
            </div>
            ...
            <div className="relative z-10 mt-12 bg-background/50 backdrop-blur-md rounded-2xl p-6 border border-border/50">
              <p className="italic text-sm text-foreground/80 mb-4">
                &quot;The most seamless and intelligent health platform I&apos;ve ever used. Managing my patient profile is a breeze.&quot;
              </p>
              <div className="flex items-center gap-3">
                ...
                <div className="text-xs">
                  <p className="font-bold text-foreground">Marcus Chen</p>
