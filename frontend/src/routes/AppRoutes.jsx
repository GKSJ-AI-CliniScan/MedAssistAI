  ...
  return (
    <Routes>
      ...
      <Route element={<ProfileGuard />}>
        ...
        {/* ========== ADMIN ROUTES ========== */}
        <Route element={<RoleGuard allowedRoles={[Role.ADMIN, Role.HOSPITAL_ADMIN]} />}>
          <Route
        ...
        {/* ========== DOCTOR ROUTES ========== */}
        <Route element={<RoleGuard allowedRoles={[Role.DOCTOR, Role.ADMIN, Role.HOSPITAL_ADMIN]} />}>
          <Route
        ...
        {/* ========== APPOINTMENT ROUTES ========== */}
        <Route element={<RoleGuard allowedRoles={[Role.APPOINTMENT, Role.ADMIN, Role.HOSPITAL_ADMIN]} />}>
          <Route
        ...
        {/* ========== PHARMACY ROUTES ========== */}
        <Route element={<RoleGuard allowedRoles={[Role.PHARMACY, Role.ADMIN, Role.HOSPITAL_ADMIN]} />}>
          <Route
